...
const SearchScreen = ({navigation}) => {
    ...
    return (<> 
        ...
        <ScrollView>
            ...
            <ResultsList navigation={navigation} results={filterResultsByPrice('$$')} title = "A Bit pricies"/>
            <ResultsList navigation={navigation} results={filterResultsByPrice('$$$')} title = "A big spender"/>
        </ScrollView>
